...
def draw_screen(screen):
    ...
    while xmontanha < screen.get_width():
        screen.blit(montanha, (xmontanha, 240))
        xmontanha = xmontanha + 300

        
    xtubo = 320
    while xtubo < screen.get_width():
        screen.blit(tubo, (xtubo, 525))
        xtubo = xtubo + 850

        
    xchao = 0
    while xchao < screen.get_width():
        screen.blit(chao, (xchao, 592))
        xchao = xchao + 128

        
    screen.blit(nuvem, (px, 110))
